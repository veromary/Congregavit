...
%\def\presecposture#1
\newcommand\presecposture[1]{\everypar={\marginpar{\fontsize{10}{10}\selectfont \textsf{\scshape #1}}\everypar={}}}
%\newcommand\presecposture[1]{\marginnote{\textsf{\scshape #1}}}
%\def\posture#1
\newcommand\posture[1]{\marginpar{\fontsize{10}{10}\selectfont \textsf{\scshape #1}}}

\def\stand{\posture{Stand}}
\def\sit{\posture{Sit}}
\def\kneel{\posture{Kneel}}
\def\HMstand{\posture{Sung Mass Stand}}
\def\ringbell{\posture{\includegraphics[width=5mm]{bell}}}
\def\threebell{\posture{\includegraphics[width=5mm]{bell}\includegraphics[width=5mm]{bell}\includegraphics[width=5mm]{bell}}}
...
\newcommand\pointtrans{\marginnote{\raggedright\footnotesize For English see below.}}

%\newcommand\pointorig{\marginpar{\footnotesize Original precedes.}}%
\newcommand\pointorig{\marginnote{\raggedright\footnotesize For original see above.}}
...
\gredefbarredsymbol{VBarBold}{\textbf{V}}{greVBarAlt}{13}{0.0mm}{0.0mm}
\gredefbarredsymbol{RBarBold}{\textbf{R}}{greRBarAlt}{13}{1.2mm}{0.2mm}
\renewcommand\Rbar{\textmd{\hbox to 1.4em{%
\anavio\smaller\RBarBold .}}}

\renewcommand\Vbar{\textmd{\hbox to 1.4em{%
\anavio\smaller\VBarBold \kern-2pt.}}}

\gredefsymbol{GreAltCross}{greextra}{Cross}

\newcommand\maltese{\GreAltCross\ }

\newcommand\Pnobar{\textmd{\hbox to 1.4em{%
\anavio \small \textbf{P.} }}}
...
\let\origsectionname\sectionname
\newcommand{\sectionposture}[2]{%
 % #1 = part title
 % #2 = margin par
 \expandafter\def\expandafter\sectionname\expandafter{\sectionname
   \marginpar{\footnotesize\scshape{#2}}}%
 \subsection*{#1}
 \let\sectionname\origsectionname
}
