...
%  Sample file to test various features of abc2ps
 ...
 % %glyph 2026 ellipsis
\relative c' \time 4/2 \key g \major  \mark "1."  g'2  g2 fis g \bar "|"
        g4 a b c8( b) a4 d b a
	\bar "|" g2 d d g \bar "|" b4 c d c8( d) d4 a r4 d~ \bar "|"
	d8 d8 c4 b a8( g) a4 a g2 \bar "|" d'2 g'2
	\bar ":|." }
