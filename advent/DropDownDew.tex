\newHymn
%\HymnTitleit{Drop down dew, ye heavens}
\JustHymnNum
\FirstLine{Drop down dew, ye heavens}
\settowidth{\versewidth}{own dew, ye heavens, from above, and let
the}

\begin{verse}[\versewidth]

\flagverse{Ant}\initialV{D}{rop} down dew, ye heavens, from above, and let the clouds rain the Just One.

\flagverse{1}Be not angry, O Lord, and remember no longer our iniquity :\\
...
\flagverse{2}We have sinned, and we are become as one unclean, and we have all
fallen as a leaf;\\
...
\flagverse{3}See, O Lord, the affliction of thy people, and send him whom thou hast
promised to send.\\
...
\flagverse{4}Be comforted, be comforted, my people; thy salvation shall speedily
come.\\
