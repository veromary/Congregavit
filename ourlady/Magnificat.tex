...
\FirstLine{Magnificat anima mea Dominum}
%\JustHymnNum

\HymnTitlesc{Canticum Beatae Mariae Virginis}
...
\FirstLine{My soul doth magnify the Lord}

\HymnTitlesc{Canticle of the Blessed Virgin Mary}
\settowidth{\versewidth}{Et exsultávit spíritus méus~* in Déo salutári méo.}
%\begin{verse}[\versewidth]
...
%[48] Shall call me blessed: These words are a prediction of that honour which the church in all ages should pay to the Blessed
%Virgin. Let Protestants examine whether they are any way concerned in this prophecy.
