...
\settowidth{\versewidth}{O salutaris Hostia}
...
\settowidth{\versewidth}{O saving victim opening wide}
...
\HymnTitleit{O salutaris}{O salutaris (Verbum supernum)}
...
\heading{St Alphonsus' Spiritual Communion}

\lettrine{M}{y Jesus,}
I believe that Thou art present in the Most Holy Sacrament.
...
\heading{Anima Christi}

\newHymn

%\FirstLine{Soul of Christ, sanctify me}
\settowidth{\versewidth}{O saving victim opening wide}

\begin{verse}[\versewidth]
\FirstVerse{S}{oul of Christ,} sanctify me.\\
...
\settowidth{\versewidth}{Tantum ergo Sacramentum}
...
\HymnTitleit{Tantum ergo}{Tantum ergo (Pange lingua)}
...
\HymnTitleit{Adoremus in aeternum}{Adoremus in aeternum}
...
%\HymnTitleit{Benedicamus Dominum.}


%\gregorioscore{gabc/rb--benedicam_dominum--solesmes_1934}

%	\Hlnote{I will bless the Lord at all times,\\
